...
#pragma mark - RSASigner

@implementation NSString (RSASigner)
...
- (NSString *)rsaSignWithPrivateKey:(NSString *)privateKey
{
    ...
    NSString *path = [documentPath stringByAppendingPathComponent:@"Arrietty-RSAPrivateKey"];
